      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-sm font-medium text-white/80">Partnership</span>
          </div>
          ...
          <p className="max-w-2xl mx-auto text-white/70 text-xl mb-10 leading-relaxed">
            Grow your logistics business with more delivery requests and powerful
            rider management tools. Join our network today.
          </p>
