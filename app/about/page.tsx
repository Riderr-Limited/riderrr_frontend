...
export default function AboutPage() {
  return (
    <div>
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 bg-linear-to-br from-[#1E5FD8] to-[#1a4fb8] text-white">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
              className="bg-linear-to-br from-blue-50 to-white p-8 rounded-2xl border border-blue-100"
            >
              <h2 className="text-3xl font-bold text-[#1E5FD8] mb-4">
                Our Mission
              </h2>
              <p className="text-gray-700 text-lg leading-relaxed">
                To simplify and streamline logistics by providing a reliable,
                transparent, and efficient platform that connects businesses
                with trusted delivery partners, ensuring fast and secure
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
              className="bg-linear-to-br from-purple-50 to-white p-8 rounded-2xl border border-purple-100"
            >
              <h2 className="text-3xl font-bold text-purple-600 mb-4">
                Our Vision
              </h2>
              <p className="text-gray-700 text-lg leading-relaxed">
                To become Africa&apos;s leading logistics platform, empowering
                businesses and riders with technology-driven solutions that make
                delivery seamless, affordable, and accessible to everyone.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-linear-to-br from-gray-50 to-white p-6 rounded-xl border border-gray-200 hover:border-[#1E5FD8] hover:shadow-lg transition-all"
              >
      ...
      {/* CTA Section */}
      <section className="py-20 bg-linear-to-br from-[#1E5FD8] to-[#1a4fb8] text-white">
