    ...
    try {
      ...
      if (data.success && data.data) {
        ...
        if (profileData.settings) {
          setSettings({
            operatingHours: profileData.settings.operatingHours || {
              start: "09:00",
              end: "18:00",
            },
            autoAccept: profileData.settings.autoAccept || false,
            commissionRate: profileData.settings.commissionRate || 15,
            notificationChannels: profileData.settings.notificationChannels || [
              "push",
              "email",
            ],
          });
                    ...
                    <div>
                      <label className="flex items-center cursor-pointer">
                        ...
                        <span className="ml-2 text-gray-700">
                          Auto-accept delivery requests
                        </span>
                      </label>
                      <p className="text-sm text-gray-500 ml-6 mt-1">
                        Automatically assign incoming deliveries to available
                        drivers
                      </p>
                    </div>
                    <button
                      ...
                      <div className="flex items-center text-green-700">
                        ...
                        <div>
                          ...
                          <p className="text-sm mt-1">
                            Your bank details have been verified and are ready
                            for payouts.
                          </p>
                        </div>
                      </div>
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {profile.onboardingDocs?.length > 0 &&
                    profile.onboardingDocs.every((doc) => doc.verified) ? (
                      <CheckCircle className="h-5 w-5 text-green-500" />
                    ) : (
                      <Clock className="h-5 w-5 text-yellow-500" />
                    )}
